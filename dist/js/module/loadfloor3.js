define(['jquery'], function($) {
    class LoadFloor3 {
        ...
        rendering_page(res) {
            ...
            for (var i in data.floor_main.col2) {
                strCol2 += `<li class="wide"><a href="javascript:;" target="_blank"><img src="${data.floor_main.col2[i]}" width="441" height="191"></a></li>`;
            }
            var strLogoList = '';
            ...
            var str = `
                <div class="floor-title">
                    <h2><a href="javascript:;" target="_blank"><i>F7</i>粮油杂货</a></h2>
                        <span class="keyword">
                            ${keyWords}
                        </span>
                    </div>
    ...
    return LoadFloor3; //index.js中需要多次调用这个通用函数，所以这里return不加new不加括号，
